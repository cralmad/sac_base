...
from .views_relatorio import (
    ...
    relatorio_rotas_exportar_xlsx_view,
    relatorio_rotas_importar_artigos_view,
    relatorio_rotas_cadastrar_produto_critico_view,
    relatorio_rotas_zona_view,
    relatorio_rotas_zona_exportar_xlsx_view,
    relatorio_sms_view,
    relatorio_sms_enviar_view,
    relatorio_sms_preview_view,
    relatorio_gerencial_view,
    relatorio_gerencial_anexo_gmail_view,
    relatorio_devolucao_view,
    relatorio_devolucao_gsheets_view,
    relatorio_fechamento_view,
    relatorio_fechamento_exportar_xlsx_view,
...
urlpatterns = [
    ...
    path(
        'relatorio_rotas/exportar-xlsx/',
        relatorio_rotas_exportar_xlsx_view,
        name='relatorio_rotas_exportar_xlsx',
    ),
    path('relatorio_rotas/importar-artigos/', relatorio_rotas_importar_artigos_view, name='relatorio_rotas_importar_artigos'),
    path('relatorio_rotas/produto-critico/', relatorio_rotas_cadastrar_produto_critico_view, name='relatorio_rotas_cadastrar_produto_critico'),
    path('relatorio_rotas_zona/', relatorio_rotas_zona_view, name='relatorio_rotas_zona'),
    path(
        'relatorio_rotas_zona/exportar-xlsx/',
        relatorio_rotas_zona_exportar_xlsx_view,
        name='relatorio_rotas_zona_exportar_xlsx',
    ),
    ...
    path(
        'relatorio_gerencial/anexo-gmail/',
        relatorio_gerencial_anexo_gmail_view,
        name='relatorio_gerencial_anexo_gmail',
    ),
    ...
    path(
        'relatorio_fechamento/exportar-xlsx/',
        relatorio_fechamento_exportar_xlsx_view,
        name='relatorio_fechamento_exportar_xlsx',
    ),
    path(
