...
from .views import (
    ...
    pedido_inc_foto_add_view,
    pedido_inc_foto_del_view,
    pedido_dev_save_view,
    pedido_inc_del_view,
    pedido_inc_list_view,
    pedido_inc_save_view,
...
urlpatterns = [
    ...
    path("logistica/pedidos/inc/list", pedido_inc_list_view, name="pedidos_inc_list"),
    path("logistica/pedidos/inc/save", pedido_inc_save_view, name="pedidos_inc_save"),
    path("logistica/pedidos/inc/del", pedido_inc_del_view, name="pedidos_inc_del"),
    path("logistica/pedidos/inc/foto/add", pedido_inc_foto_add_view, name="pedidos_inc_foto_add"),
